...
export default function ProjectIntro() {
  return (
    <section className="relative h-[65vh] md:h-[75vh] flex items-center justify-center bg-black">
      {/* Background Image */}
      <div
      ...
      >
        ...
        <p className="text-white/90 max-w-2xl mx-auto text-lg md:text-xl drop-shadow-sm">
